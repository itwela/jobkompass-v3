...
export const metadata = {
  title: "Contact | JobKompass",
  description: "Get in touch with the JobKompass team.",
};
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Have questions, feedback, or ideas for JobKompass? Send us a message
            ...
            <div className="rounded-xl border border-border bg-card p-6 space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <Input placeholder="Your name" sanitize={false} />
                </div>
                <div className="space-y-1">
                  <label className="text-sm font-medium">Email</label>
                  <Input placeholder="you@example.com" type="email" sanitize={false} />
                </div>
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium">Subject</label>
                <Input placeholder="How can we help?" sanitize={false} />
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium">Message</label>
                <Textarea
                  placeholder="Share as much context as you like about your question or feedback..."
                  rows={5}
                  sanitize={false}
                />
              </div>
              <div className="pt-2">
                {/* This is a static UI stub; wire to backend/email service when ready */}
                <Button className="w-full sm:w-auto">Send message</Button>
              </div>
            </div>

            <div className="text-xs text-muted-foreground">
              For account or billing issues, please include the email address associated
              with your JobKompass account so we can help you faster.
            </div>
          </div>
        </section>
      </main>
